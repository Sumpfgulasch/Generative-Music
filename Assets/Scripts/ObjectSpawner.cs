...
public class ObjectSpawner : MonoBehaviour
{
    ...
    IEnumerator SpawnObject()
    {
        ...
        for (int i = 0; i<objectCount-1; i++)
        {
            ...
            activeObjects.Add(Instantiate(newObj, new Vector3(0, 0, zSpawn + i*moveSpeed*spawnRhythm*120), Quaternion.identity));
        }
        ...
        while (true)
        {
            ...
            GameObject newObj = objects[Random.Range(0, objects.Count)];
            activeObjects.Add(Instantiate(newObj, new Vector3(0, 0, zSpawn + objectCount*moveSpeed*spawnRhythm*120), Quaternion.identity));
