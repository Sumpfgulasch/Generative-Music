Shader "Universal Render Pipeline/Custom/Stencil_maskedObj"
{
	Properties
	{
		...
		SubShader
	{
		...
		Tags{ "RenderType" = "Opaque" "RenderPipeline" = "UniversalRenderPipeline" "IgnoreProjector" = "True" "Queue" = "Geometry+2" }
		LOD 300
